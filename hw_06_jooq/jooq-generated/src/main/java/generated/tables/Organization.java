...
public class Organization extends TableImpl<OrganizationRecord> {
    ...
    /**
     * The column <code>public.organization.account</code>.
     */
    public final TableField<OrganizationRecord, Long> ACCOUNT = createField(DSL.name("account"), SQLDataType.BIGINT.nullable(false), this, "");
